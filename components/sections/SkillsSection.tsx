...
import SkillsCarousel from "../primitives/SkillsCarousel";
  ...
  return (
    <div ref={ref}>
      ...
      <p className="max-w-2xl font-mono text-sm uppercase leading-relaxed tracking-widest text-terminal-soft">
        Full Stack Software Engineer specializing in Laravel, MERN, and Applied AI—building scalable backend systems, high-performance APIs, AI agents, RAG applications, and production-ready SaaS solutions.
